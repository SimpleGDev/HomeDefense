...
public class BaseTower extends MapLayer {
    ...
    public BaseTower(TiledMap world, String imagePath, String name, float x, float y, int width, int height, Color radiusColor, float radius) {
        this.initialize(world, imagePath, name, x, y, width, height, radiusColor, radius);
    }

    public BaseTower(TiledMap world, String imagePath, String name, Vector2 xy, int width, int height, Color radiusColor, float radius) {
        this.initialize(world, imagePath, name, xy.x, xy.y, width, height, radiusColor, radius);
    }

    private void initialize(TiledMap world, String imagePath, String name, float x, float y, int width, int height, Color radiusColor, float radius) {
        mWorld = world;
