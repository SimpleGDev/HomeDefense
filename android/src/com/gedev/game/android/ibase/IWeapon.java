 ...
 */
public abstract class IWeapon extends Immortal {
    ...
    public IWeapon(String name, float x, float y, float range, int damage, float distance) {
        super(name, x, y);
        initialize(range, damage, distance);
    }

    public IWeapon(String name, float x, float y, float range, int damage, float distance, float coolDown) {
        super(name, x, y);
